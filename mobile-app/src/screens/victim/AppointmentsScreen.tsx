      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 20, paddingBottom: 100 }}>
        {appointments.length === 0 ? (
          <View style={{ alignItems: 'center', marginTop: 48 }}>
            ...
            <Text style={{ color: '#75759E', fontSize: 15, marginTop: 12, fontWeight: '600' }}>
          ...
          appointments.map((appt) => (
            <View key={appt.id} style={{
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }}>
                <Text style={{ fontSize: 15, fontWeight: '800', color: '#1E1E2D', flex: 1, marginRight: 8 }}>
                  {appt.title}
                </Text>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 6 }}>
                ...
                <Text style={{ fontSize: 12, fontWeight: '700', color: '#5B3FD3', marginLeft: 4 }}>
                  {appt.dateTime}
                </Text>
              </View>
      ...
      {activeTab === 'upcoming' && (
        <View style={{
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.85}
          >
            <Text style={{ color: '#FFFFFF', fontWeight: '800', fontSize: 16 }}>Book Appointment</Text>
          </TouchableOpacity>
        </View>
      )}
    </SafeAreaView>
