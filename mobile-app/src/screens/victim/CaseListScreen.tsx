...
export const CaseListScreen = ({ navigation }: any) => {
  ...
  const [selectedFilter, setSelectedFilter] = useState<'All' | 'New' | 'In Progress' | 'Resolved'>('All');
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#F8F9FE' }}>
      ...
      <View style={{
        ...
        <Text style={{ fontSize: 22, fontWeight: '800', color: '#1E1E2D', marginBottom: 12 }}>
        ...
        <View style={{
          ...
          <TextInput
            ...
            style={{ flex: 1, paddingVertical: 10, marginLeft: 8, fontSize: 14, color: '#1E1E2D' }}
            value={searchQuery}
      ...
      {/* Filter pills */}
      <View style={{ backgroundColor: '#FFFFFF', paddingVertical: 10, paddingHorizontal: 16, borderBottomWidth: 1, borderBottomColor: '#F0F0F5' }}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          {(['All', 'New', 'In Progress', 'Resolved'] as const).map((filter) => {
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 20, paddingBottom: 100 }}>
        {loading ? (
          <ActivityIndicator size="small" color="#5B3FD3" style={{ marginTop: 24 }} />
        ) : filteredCasesList.length === 0 ? (
          <View style={{ alignItems: 'center', marginTop: 48 }}>
            <Ionicons name="folder-open-outline" size={48} color="#B0B0C8" />
            <Text style={{ color: '#1E1E2D', fontSize: 15, fontWeight: '700', marginTop: 12 }}>No Cases Found</Text>
          ...
          filteredCasesList.map((c) => {
            ...
            return (
              ...
              >
                ...
                <Text style={{ fontSize: 13, fontWeight: '600', color: '#5B3FD3', marginBottom: 6 }}>
                  {c.type}
                </Text>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    <Text style={{ fontSize: 12, fontWeight: '700', color: '#5B3FD3', marginRight: 4 }}>
