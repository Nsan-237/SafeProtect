        ...
        {state.routes.map((route: any, index: number) => {
          ...
          const iconFocused: any = (() => {
            switch (route.name) {
              ...
              case 'Reports':   return isFocused ? 'document-text' : 'document-text-outline';
              case 'Cases':     return isFocused ? 'folder' : 'folder-outline';
              case 'Dashboard': return isFocused ? 'home' : 'home-outline';
              case 'Services':  return isFocused ? 'heart' : 'heart-outline';
              case 'Appointments': return isFocused ? 'calendar' : 'calendar-outline';
